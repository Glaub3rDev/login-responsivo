...
- Ícones via **Google Material Symbols**  
- Campos com estilos personalizados de foco e hover  
- Paleta de cores configurada com variáveis CSS  
...
- **Google Fonts / Material Symbols** — Iconografia  
